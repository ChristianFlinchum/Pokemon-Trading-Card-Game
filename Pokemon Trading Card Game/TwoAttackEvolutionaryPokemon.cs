...
{
    class TwoAttackEvolutionaryPokemon: PokemonCard
    {
        //Field
        private bool _basic;
        private bool _play;
        ...
        //Constuctor
        public TwoAttackEvolutionaryPokemon(string name, string type, string weakness, string resistanceType,
            int resistanceAmount, int hp, int retreatCost, string evolvesInto, string evolvesFrom, string attack1Name,
        ...
        //EvolvesFrom Property(Read-only)
        public string EvolvesFrom
        {
            get { return _evolvesFrom; }
        }

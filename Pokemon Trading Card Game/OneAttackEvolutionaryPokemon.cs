...
{
    class OneAttackEvolutionaryPokemon: PokemonCard
    {
        //Field
        private bool _basic;
        private bool _play;
        ...
        //Constuctor
        public OneAttackEvolutionaryPokemon(string name, string type, string weakness, string resistanceType,
            int resistanceAmount, int hp, int retreatCost, string evolvesInto, string evolvesFrom, string attackName,
